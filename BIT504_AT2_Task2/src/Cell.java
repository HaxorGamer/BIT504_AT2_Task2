...
public class Cell {
	...
	public Cell(int row, int col) {
		...
		// this sets the two variables for row and col 

		this.row = row;
		this.col = col;
		
		//this will call the clear method which should make all cells empty
		clear();
	...
	public void clear() {
		...
		// this sets the content of a cell to be Player.Empty
