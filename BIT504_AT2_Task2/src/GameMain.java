...
public class GameMain extends JPanel implements MouseListener{
	...
	//created the enumeration for the GameState currentState -Nick
	...
	public GameMain() {   
		...
		// added event listener to listen for mouse input         
		...
		// made a new instance of the board using the board variable
		board = new Board();
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
	         public void run() {
				...
				//this will draw a window that contains the game
				frame.add(new GameMain());
				
				
				//added the default close option for the frame, this will end the game and it will no longer be running on the computer
	  ...
	  /** Initialise the game-board contents and the current status of GameState and Player) */
		...
		public void updateGame(Player thePlayer, int row, int col) {
			...
			if(board.hasWon(thePlayer, row, col)) {
				...
				// this will check the value returned by board.hasWon with both X and O then update the gamestate to thw winner
				...
				// if neither player won then it will change the gamestate to a draw 
	...
	public void mouseClicked(MouseEvent e) {  
		...
		//every time the game updates it will redraw what is shown         
           repaint();
	}
